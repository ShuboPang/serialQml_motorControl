...
SerialTest::SerialTest(QSerialPort *parent):QSerialPort (parent),m_receivedata(""),m_receivenumber(""),m_sendnumber("")
{
...
int SerialTest::openAndSetPort(int PortNameIndex,int BaudRateIndex,int DatabitsIndex,int ParityIndex,int StopbitsIndex,int FlowcontrolIndex)
{
    ////////////////////1.得到当前选择的各项设置//////////////////////////////
    //得到当前端口名
